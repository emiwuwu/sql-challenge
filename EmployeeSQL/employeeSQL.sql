...
SELECT d.dept_no, d.dep_name, dm.emp_no, e.last_name, e.first_name
FROM departments d
...
SELECT d.dept_no, e.emp_no, e.last_name, e.first_name, d.dep_name
FROM (
...
FROM employees
WHERE first_name = 'Hercules' OR last_name ~ '^B';
